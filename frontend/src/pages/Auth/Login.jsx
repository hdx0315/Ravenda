  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4 font-main">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-md w-full">
        <h1 className="text-3xl font-semibold text-center mb-6 text-pink-500">Sign In</h1>
        ...
        <p className="mt-8 text-center text-gray-500">
          ...
          <a href="/auth/signup" className="ml-2 text-pink-500 hover:underline">Sign Up</a>
        </p>
      </div>
    </div>
  );
